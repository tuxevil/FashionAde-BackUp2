...
namespace ContactProvider.Helpers
{
    ...
    class WindowsLiveLogin
    {
        ...
        public WindowsLiveLogin(bool loadAppSettings)
        {
            ...
            AppId = appSettings["Live_ApplicationId"];
            Secret = appSettings["Live_Secret"];
            OldSecret = appSettings["Live_OldSecret"];
            OldSecretExpiry = appSettings["Live_OldSecretExpiracy"];
            SecurityAlgorithm = appSettings["Live_SecurityAlgorithm"];
            PolicyUrl = appSettings["SiteURL"] + appSettings["Live_PolicyUrl"];
            ReturnUrl = appSettings["SiteURL"] + appSettings["Live_ReturnUrl"];
            BaseUrl = appSettings["Live_BaseUrl"];
            SecureUrl = appSettings["Live_SecureUrl"];
            ConsentUrl = appSettings["Live_ConsentUrl"];
        }
        ...
        public WindowsLiveLogin(string settingsFile)
        {
            ...
            AppId = settings["Live_ApplicationId"];
            Secret = settings["Live_Secret"];
            OldSecret = settings["Live_OldSecret"];
            OldSecretExpiry = settings["Live_OldSecretExpiracy"];
            SecurityAlgorithm = settings["Live_SecurityAlgorithm"];
            PolicyUrl = settings["SiteURL"] + settings["Live_PolicyUrl"];
            ReturnUrl = settings["SiteURL"] + settings["Live_ReturnUrl"];
            BaseUrl = settings["Live_BaseUrl"];
            SecureUrl = settings["Live_SecureUrl"];
            ConsentUrl = settings["Live_ConsentUrl"];
        }
